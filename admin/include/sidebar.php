...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
 $result = mysqli_query($con,"SELECT DISTINCT orders.bill_no FROM Orders where orderDate Between '$from' and '$to' and orders.orderStatus!='Delivered' ");
...
?>
									...
									<li>
										...
										<?php	
	$status='Delivered';									 
$ret = mysqli_query($con,"SELECT DISTINCT orders.bill_no FROM Orders where orderStatus!='$status' ");
...
<?php } ?>
								...
								<?php	
	$status='Delivered';									 
$rt = mysqli_query($con,"SELECT DISTINCT orders.bill_no FROM Orders where orderStatus='$status'");
