...
if(isset($_POST['submit']))
{
	...
	$cid=$result['cid']+1;
	$dir="productimages/$cid";
if(!is_dir($dir))
{
		mkdir("productimages/".$cid);
}

	move_uploaded_file($_FILES["productimage1"]["tmp_name"],"productimages/$cid/".$_FILES["productimage1"]["name"]);
	move_uploaded_file($_FILES["productimage2"]["tmp_name"],"productimages/$cid/".$_FILES["productimage2"]["name"]);
	move_uploaded_file($_FILES["productimage3"]["tmp_name"],"productimages/$cid/".$_FILES["productimage3"]["name"]);
