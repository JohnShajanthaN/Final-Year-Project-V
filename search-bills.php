...
<?php include('include/sidebar.php');?>				
    ...
    <form name="search" method="post" action="search-result.php">
            ...
            <button class="btn btn-success" type="submit" name="search" style="font-weight:bold;font-size:16px;height:30px;border-radius:200px;width:100px;border-color:darkgrey;"> search </button>   
